        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              AI analysis of {totalReviews} customer reviews • Shows how customers really feel about your restaurant
            </p>
          </div>
        </div>
          ...
          <div className="flex items-center gap-2 mb-4">
            ...
            <div className="group relative ml-2">
              ...
              <div className="absolute left-1/2 transform -translate-x-1/2 bottom-full mb-2 hidden group-hover:block w-80 p-3 bg-gray-900 text-white text-xs rounded-lg shadow-lg z-10">
                <div className="font-semibold mb-1">How we categorize your reviews:</div>
                <div className="space-y-1">
                  <div>• <span className="font-medium">Ecstatic/Delighted:</span> 5-star reviews with enthusiastic language</div>
                  <div>• <span className="font-medium">Satisfied:</span> 4-star reviews and positive 3-star reviews</div>
                  <div>• <span className="font-medium">Neutral:</span> 3-star reviews with neutral language</div>
                  <div>• <span className="font-medium">Frustrated/Disappointed:</span> 2-star and negative reviews</div>
                </div>
                <div className="mt-2 text-yellow-200">💡 Each review is placed in exactly one category based on rating + language analysis</div>
              </div>
            </div>
          </div>
              ...
              {sentimentData.map((sentiment) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-bold text-purple-600 w-10 bg-purple-50 px-2 py-1 rounded">{sentiment.value}%</span>
                  </div>
                </motion.div>
              ))}
            </div>
