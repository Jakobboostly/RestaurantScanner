...
export class ApifyReviewsService {
  ...
  async getGoogleReviews(placeId: string) {
    ...
    try {
      ...
      console.log('📊 Total reviews from Google Places:', place.reviewsCount);
      console.log('⭐ Average rating from Google Places:', place.totalScore);
      ...
      if (!place.reviews || !Array.isArray(place.reviews) || place.reviews.length === 0) {
        ...
        return { 
          ...
          metadata: { 
            ...
            averageRating: place.totalScore || place.avgRating || 0 
          } 
        };
      }
      ...
      return {
        ...
        metadata: {
          totalReviews: place.reviewsCount || transformedReviews.length,
          averageRating: place.totalScore || place.avgRating || 0,
