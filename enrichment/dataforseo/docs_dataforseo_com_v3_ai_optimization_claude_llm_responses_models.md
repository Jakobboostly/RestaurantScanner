[NAV![Navbar](https://docs.dataforseo.com/v3/wp-content/themes/ntsame/img/navbar.png)](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/#)
...
- [SERP API](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Google](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Organic](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
      ...
      - [Task GET](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
      ...
      - [Live](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [AI Mode](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Maps](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Local Finder](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [News](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Events](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Images](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Search By Image](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Jobs](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Autocomplete](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Dataset Search](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Dataset Info](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Ads Advertisers](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Ads Search](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Finance Explore](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Finance Markets](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Finance Quote](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Finance Ticker Search](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Bing](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Local Pack](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [YouTube](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Video Info](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Video Subtitles](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Video Comments](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Yahoo](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Baidu](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Naver](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Seznam](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
...
- [AI Optimization API](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  - [Overview](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  - [AI Keyword Data](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Chat GPT](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    - [LLM Responses](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Claude](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    - [LLM Responses](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Gemini](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    - [LLM Responses](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Perplexity](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    - [LLM Responses](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
...
- [Keywords Data API](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Google Ads](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Search Volume](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Keywords For Site](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Keywords For Keywords](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Ad Traffic By Keywords](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Bing Ads](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Search Volume History](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Keyword Performance](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Keyword Suggestions For URL](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Audience Estimation](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Google Trends](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Explore](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [DataForSEO Trends](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Clickstream Data](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
...
- [Domain Analytics API](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Technologies](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Whois](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
...
- [DataForSEO Labs API](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Google](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Keyword Research](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Market analysis](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Competitor Research](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Amazon](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Google Play](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [App Store](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
...
- [Backlinks API](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
...
- [OnPage API](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Lighthouse](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
...
- [Content Analysis API](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
...
- [Content Generation API](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
...
- [Merchant API](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Google Shopping](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Products](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Sellers](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Product Specification](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Product Info](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Reviews](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Amazon](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [ASIN](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
...
- [App Data API](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Google](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [App Searches](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [App List](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [App Info](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [App Reviews](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [App Listings](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Apple](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
...
- [Business Data API](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Business Listings](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Google](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Google My Business](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
      - [My Business Info](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
      ...
      - [My Business Updates](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Google Hotels](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
      - [Hotel Searches](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
      ...
      - [Hotel Info](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Google Reviews](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Extended Reviews](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Questions And Answers](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Trustpilot](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    - [Overview](https://docs.dataforseo.com/v3/business_data/trustpilot/overview/?bash)
    - [Trustpilot Search](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Trustpilot Reviews](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Tripadvisor](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Tripadvisor Search](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    ...
    - [Tripadvisor Reviews](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Social Media](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
...
- [Databases](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  - [Overview](https://docs.dataforseo.com/v3/databases/overview/?bash)
  - [Backlink Domains](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    - [Backlink Summary Database](https://docs.dataforseo.com/v3/databases/backlink_summary/?bash)
  - [Google](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
    - [SERPs Databases](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
  ...
  - [Google Historical](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
...
- [Appendix](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/models/?bash)
...
\
    {\
\
      "id": "07211855-1535-0616-0000-13c3c3181e58",\
\
      "status_code": 20000,\
\
      "status_message": "Ok.",\
