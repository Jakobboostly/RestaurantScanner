[NAV![Navbar](https://docs.dataforseo.com/v3/wp-content/themes/ntsame/img/navbar.png)](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/#)
...
- [SERP API](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Google](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Organic](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
      ...
      - [Task GET](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
      ...
      - [Live](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [AI Mode](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Maps](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Local Finder](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [News](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Events](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Images](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Search By Image](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Jobs](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Autocomplete](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Dataset Search](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Dataset Info](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Ads Advertisers](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Ads Search](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Finance Explore](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Finance Markets](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Finance Quote](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Finance Ticker Search](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Bing](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Local Pack](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [YouTube](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Video Info](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Video Subtitles](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Video Comments](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Yahoo](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Baidu](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Naver](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Seznam](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
...
- [AI Optimization API](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  - [Overview](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  - [AI Keyword Data](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Chat GPT](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    - [LLM Responses](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Claude](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    - [LLM Responses](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Gemini](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    - [LLM Responses](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Perplexity](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    - [LLM Responses](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
...
- [Keywords Data API](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Google Ads](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Search Volume](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Keywords For Site](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Keywords For Keywords](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Ad Traffic By Keywords](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Bing Ads](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Search Volume History](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Keyword Performance](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Keyword Suggestions For URL](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Audience Estimation](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Google Trends](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Explore](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [DataForSEO Trends](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Clickstream Data](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
...
- [Domain Analytics API](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Technologies](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Whois](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
...
- [DataForSEO Labs API](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Google](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Keyword Research](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Market analysis](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Competitor Research](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Amazon](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Google Play](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [App Store](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
...
- [Backlinks API](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
...
- [OnPage API](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Lighthouse](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
...
- [Content Analysis API](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
...
- [Content Generation API](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
...
- [Merchant API](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Google Shopping](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Products](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Sellers](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Product Specification](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Product Info](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Reviews](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Amazon](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [ASIN](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
...
- [App Data API](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Google](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [App Searches](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [App List](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [App Info](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [App Reviews](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [App Listings](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Apple](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
...
- [Business Data API](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Business Listings](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Google](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Google My Business](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
      - [My Business Info](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
      ...
      - [My Business Updates](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Google Hotels](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
      - [Hotel Searches](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
      ...
      - [Hotel Info](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Google Reviews](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Extended Reviews](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Questions And Answers](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Trustpilot](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    - [Overview](https://docs.dataforseo.com/v3/business_data/trustpilot/overview/?bash)
    - [Trustpilot Search](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Trustpilot Reviews](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Tripadvisor](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Tripadvisor Search](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    ...
    - [Tripadvisor Reviews](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Social Media](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
...
- [Databases](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  - [Overview](https://docs.dataforseo.com/v3/databases/overview/?bash)
  - [Backlink Domains](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    - [Backlink Summary Database](https://docs.dataforseo.com/v3/databases/backlink_summary/?bash)
  - [Google](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
    - [SERPs Databases](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
  ...
  - [Google Historical](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
...
- [Appendix](https://docs.dataforseo.com/v3/ai_optimization/llm_responses/overview/?bash)
...
• [ChatGPT Live](https://docs.dataforseo.com/v3/ai_optimization/chat_gpt/llm_responses/live/)

• [ChatGPT Task POST](https://docs.dataforseo.com/v3/ai_optimization/chat_gpt/llm_responses/task_post/)

• [ChatGPT Tasks Ready](https://docs.dataforseo.com/v3/ai_optimization/chat_gpt/llm_responses/tasks_ready/)

• [ChatGPT Task GET](https://docs.dataforseo.com/v3/ai_optimization/chat_gpt/llm_responses/task_get/)

• [Claude Live](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/live/)

• [Claude Task POST](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/task_post/)

• [Claude Tasks Ready](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/tasks_ready/)

• [Claude Task GET](https://docs.dataforseo.com/v3/ai_optimization/claude/llm_responses/task_get/)

**Gemini** and **Perplexity** in LLM Responses API support only the Live method of data retrieval:

• [Gemini Live](https://docs.dataforseo.com/v3/ai_optimization/gemini/llm_responses/live/)
