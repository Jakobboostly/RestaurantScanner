[NAV![Navbar](https://docs.dataforseo.com/v3/wp-content/themes/ntsame/img/navbar.png)](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash#)
...
- [SERP API](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Google](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Organic](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
      ...
      - [Task GET](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
      ...
      - [Live](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [AI Mode](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Maps](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Local Finder](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [News](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Events](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Images](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Search By Image](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Jobs](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Autocomplete](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Dataset Search](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Dataset Info](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Ads Advertisers](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Ads Search](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Finance Explore](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Finance Markets](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Finance Quote](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Finance Ticker Search](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Bing](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Local Pack](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [YouTube](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Video Info](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Video Subtitles](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Video Comments](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Yahoo](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Baidu](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Naver](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Seznam](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
...
- [AI Optimization API](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  - [Overview](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  - [AI Keyword Data](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Chat GPT](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    - [LLM Responses](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Claude](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    - [LLM Responses](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Gemini](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    - [LLM Responses](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Perplexity](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    - [LLM Responses](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
...
- [Keywords Data API](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Google Ads](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Search Volume](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Keywords For Site](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Keywords For Keywords](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Ad Traffic By Keywords](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Bing Ads](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Search Volume History](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Keyword Performance](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Keyword Suggestions For URL](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Audience Estimation](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Google Trends](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Explore](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [DataForSEO Trends](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Clickstream Data](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
...
- [Domain Analytics API](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Technologies](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Whois](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
...
- [DataForSEO Labs API](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Google](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Keyword Research](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Market analysis](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Competitor Research](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Amazon](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Google Play](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [App Store](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
...
- [Backlinks API](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
...
- [OnPage API](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Lighthouse](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
...
- [Content Analysis API](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
...
- [Content Generation API](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
...
- [Merchant API](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Google Shopping](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Products](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Sellers](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Product Specification](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Product Info](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Reviews](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Amazon](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [ASIN](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
...
- [App Data API](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Google](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [App Searches](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [App List](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [App Info](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [App Reviews](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [App Listings](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Apple](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
...
- [Business Data API](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Business Listings](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Google](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Google My Business](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
      - [My Business Info](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
      ...
      - [My Business Updates](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Google Hotels](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
      - [Hotel Searches](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
      ...
      - [Hotel Info](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Google Reviews](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Extended Reviews](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Questions And Answers](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Trustpilot](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    - [Overview](https://docs.dataforseo.com/v3/business_data/trustpilot/overview/?bash)
    - [Trustpilot Search](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Trustpilot Reviews](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Tripadvisor](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Tripadvisor Search](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    ...
    - [Tripadvisor Reviews](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Social Media](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
...
- [Databases](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  - [Overview](https://docs.dataforseo.com/v3/databases/overview/?bash)
  - [Backlink Domains](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    - [Backlink Summary Database](https://docs.dataforseo.com/v3/databases/backlink_summary/?bash)
  - [Google](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
    - [SERPs Databases](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  ...
  - [Google Historical](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
...
- [Appendix](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
...
• [AI Keyword Data API](https://docs.dataforseo.com/v3/ai_optimization/ai_keyword_data/overview/) delivers search volume estmates and user intent insights based on keyword usage in AI tools like ChatGPT and other large language models.
