[NAV![Navbar](https://docs.dataforseo.com/v3/wp-content/themes/ntsame/img/navbar.png)](https://docs.dataforseo.com/v3/serp/screenshot/?bash#)
...
- [SERP API](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Google](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Organic](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
      ...
      - [Task GET](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
      ...
      - [Live](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [AI Mode](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Maps](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Local Finder](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [News](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Events](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Images](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Search By Image](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Jobs](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Autocomplete](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Dataset Search](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Dataset Info](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Ads Advertisers](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Ads Search](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Finance Explore](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Finance Markets](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Finance Quote](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Finance Ticker Search](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Bing](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Local Pack](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [YouTube](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Video Info](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Video Subtitles](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Video Comments](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Yahoo](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Baidu](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Naver](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Seznam](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
...
- [AI Optimization API](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  - [Overview](https://docs.dataforseo.com/v3/ai_optimization/overview/?bash)
  - [AI Keyword Data](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Chat GPT](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    - [LLM Responses](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Claude](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    - [LLM Responses](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Gemini](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    - [LLM Responses](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Perplexity](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    - [LLM Responses](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
...
- [Keywords Data API](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Google Ads](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Search Volume](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Keywords For Site](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Keywords For Keywords](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Ad Traffic By Keywords](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Bing Ads](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Search Volume History](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Keyword Performance](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Keyword Suggestions For URL](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Audience Estimation](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Google Trends](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Explore](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [DataForSEO Trends](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Clickstream Data](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
...
- [Domain Analytics API](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Technologies](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Whois](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
...
- [DataForSEO Labs API](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Google](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Keyword Research](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Market analysis](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Competitor Research](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Amazon](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Google Play](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [App Store](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
...
- [Backlinks API](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
...
- [OnPage API](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Lighthouse](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
...
- [Content Analysis API](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
...
- [Content Generation API](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
...
- [Merchant API](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Google Shopping](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Products](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Sellers](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Product Specification](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Product Info](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Reviews](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Amazon](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [ASIN](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
...
- [App Data API](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Google](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [App Searches](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [App List](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [App Info](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [App Reviews](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [App Listings](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Apple](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
...
- [Business Data API](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Business Listings](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Google](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Google My Business](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
      - [My Business Info](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
      ...
      - [My Business Updates](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Google Hotels](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
      - [Hotel Searches](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
      ...
      - [Hotel Info](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Google Reviews](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Extended Reviews](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Questions And Answers](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Trustpilot](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    - [Overview](https://docs.dataforseo.com/v3/business_data/trustpilot/overview/?bash)
    - [Trustpilot Search](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Trustpilot Reviews](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Tripadvisor](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Tripadvisor Search](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    ...
    - [Tripadvisor Reviews](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Social Media](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
...
- [Databases](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  - [Overview](https://docs.dataforseo.com/v3/databases/overview/?bash)
  - [Backlink Domains](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    - [Backlink Summary Database](https://docs.dataforseo.com/v3/databases/backlink_summary/?bash)
  - [Google](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
    - [SERPs Databases](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
  ...
  - [Google Historical](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
...
- [Appendix](https://docs.dataforseo.com/v3/serp/screenshot/?bash)
...
\
    {\
\
      "id": "07131549-1535-0454-0000-488f72f73457",\
\
      "status_code": 20000,\
\
      "status_message": "Ok.",\
...
\
            {\
\
              "image": "https://api.dataforseo.com/cdn/s/66fd833b-12ba-4e78-af23-ad3e436bb839"\
\
            }\
\
          ]\
...
| `browser_screen_scale_factor` | float | _browser scale factor_<br>optional field<br>can be specified in the following range: `0.5-3` |  |
| `page` | integer | _number of SERP pages_<br>optional field<br>if `depth` in the corresponding Task POST request exceeds 100 results (or 1 SERP page), specify the number of SERP pages to screenshot;<br>default value: `1` |  |
