[NAV![Navbar](https://docs.dataforseo.com/v3/wp-content/themes/ntsame/img/navbar.png)](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#)
...
*   [SERP API](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash)
    ...
    *   [Google](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash)
        ...
        *   [Autocomplete](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash)
        ...
        *   [Finance Ticker Search](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash)
    ...
    *   [YouTube](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash)
...
*   [DataForSEO Labs API](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash)
    ...
    *   [Google](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash)
        ...
        *   [Keyword Research](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash)
...
\# POST POST /v3/serp/google/local\_finder/live/html

\# in addition to 'google' and 'local\_finder' you can also set other search engine and type parameters

\# the full list of possible parameters is available in documentation

response = client.post("/v3/serp/google/local\_finder/live/html", post\_data)
...

{
...

    {
...

        {
            ...
            var taskPostResponse = await httpClient.PostAsync("/v3/serp/google/local\_finder/live/html", new StringContent(JsonConvert.SerializeObject(postData)));
...
| Field name | Type | Description |
| --- | --- | --- | --- |
| `version` | string | _the current version of the API_ | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#version) |
| `status_code` | integer | _general status code_  <br>you can find the full list of the response codes [here](https://docs.dataforseo.com/v3/appendix/errors)<br>  <br>**Note:** we strongly recommend designing a necessary system for handling related exceptional or error conditions | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#status_code) |
| `status_message` | string | _general informational message_  <br>you can find the full list of general informational messages [here](https://docs.dataforseo.com/v3/appendix/errors) | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#status_message) |
| `time` | string | _execution time, seconds_ | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#time) |
| `cost` | float | _total tasks cost, USD_ | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#cost) |
| `tasks_count` | integer | _the number of tasks in the **`tasks`** array_ | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#tasks_count) |
| `tasks_error` | integer | _the number of tasks in the **`tasks`** array returned with an error_ | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#tasks_error) |
| **`tasks`** | array | _array of tasks_ | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#tasks) |
| `id` | string | _task identifier_  <br>**unique task identifier in our system in the [UUID](https://en.wikipedia.org/wiki/Universally_unique_identifier)<br> format** | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#tasks_id) |
| `status_code` | integer | _status code of the task_  <br>generated by DataForSEO; can be within the following range: 10000-60000  <br>you can find the full list of the response codes [here](https://docs.dataforseo.com/v3/appendix/errors) | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#tasks_status_code) |
| `status_message` | string | _informational message of the task_  <br>you can find the full list of general informational messages [here](https://docs.dataforseo.com/v3/appendix/errors) | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#tasks_status_message) |
| `time` | string | _execution time, seconds_ | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#tasks_time) |
| `cost` | float | _cost of the task, USD_ | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#tasks_cost) |
| `result_count` | integer | _number of elements in the **`result`** array_ | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#tasks_result_count) |
| `path` | array | _URL path_ | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#tasks_path) |
| `data` | object | _contains the same parameters that you specified in the POST request_ | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#tasks_data) |
| **`result`** | array | _array of results_ | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#tasks_result) |
| `keyword` | string | _keyword received in a POST array  <br>_**keyword is returned with decoded %## (plus character ‘+’ will be decoded to a space character)** | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#tasks_result_keyword) |
| `type` | string | _search engine type in a POST array_ | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#tasks_result_type) |
| `se_domain` | string | _search engine domain in a POST array_ | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#tasks_result_se_domain) |
| `location_code` | integer | _location code in a POST array_ | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#tasks_result_location_code) |
| `language_code` | string | _language code in a POST array_ | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#tasks_result_language_code) |
| `datetime` | string | _date and time when the result was received_  <br>in the UTC format: “yyyy-mm-dd hh-mm-ss +00:00”  <br>example:  <br>`2019-11-15 12:57:46 +00:00` | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#tasks_result_datetime) |
| `items_count` | integer | _the number of results returned in the **`items`** array_ | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#tasks_result_items_count) |
| **`items`** | array | _elements of search results found in SERP_ | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#tasks_result_items) |
| `page` | integer | _serial number of the returned HTML page_ | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#tasks_result_items_page) |
| `date` | string | _date and time when the HTML page was scanned  <br>_in the format: “year-month-date:minutes:UTC\_difference\_hours:UTC\_difference\_minutes”  <br>example:  <br>`2019-11-15 12:57:46 +00:00` | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#tasks_result_items_date) |
| `html` | string | _HTML page_ | [](https://docs.dataforseo.com/v3/serp/google/local_finder/live/html/?bash#tasks_result_items_date_html) |
